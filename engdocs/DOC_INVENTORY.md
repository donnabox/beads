...
| `BDP_GRAPH_REPLICATION_ADR.md` | Keep | Replication implementation contract under ruling 14; explicit engine qualification gates remain open. Source baseline and last review date are recorded; no runtime or migration clearance. |
