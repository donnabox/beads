...
// Reused from Jim Wordelman's #6358/#6661 implementation, exact source
// 64becbc335cd754efa1f68effcbd5ca3f33873db. This preview integrates only the
// create-path hooks and explicitly scoped recording. The upstream coverage
// discussion below is not a completeness claim for this integration branch.
