...
tree's own conventions were read closely. Seven three-reviewer councils
(Claude, Codex, Gemini) reviewed v1–v8; §2 records what changed and which
...
internal/storage/authority/      THE WITNESS MANAGER (clone-local half; no SQL)
  ...
  Advance takes a provider-supplied Verifier (ledger-prefix + ancestry) and runs it under
    the file lock; LeaseClaim{InstallationKey, Epoch} lives in internal/storage/graphcap
